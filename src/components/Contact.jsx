        ...
        >
          <div className="flex flex-col gap-5">
            <input
              ...
              className="p-4 rounded-md text-sm dark:bg-darkModeThird dark:border-gray-400 dark:text-gray-300"
              name="firstName"
              value={firstName}
          ...
          <div>
            <textarea
              placeholder="Message..."
              className="rounded-md p-4 w-full text-sm h-[342px] dark:bg-darkModeThird dark:border-gray-400 dark:text-gray-300"
              value={message}
              name="message"
              onChange={handleChange}
            ></textarea>
